...
class SubjectDetails {
  ...
  SubjectDetails(this.subject1, this.duration, String studentName, int age,
      ...
      : student =
            Student(studentName, age, grade), // Calling Student constructor
        teacher =
            Teacher(teacherName, age, subject1); // Creating Teacher object

  // Property to hold the Teacher object
